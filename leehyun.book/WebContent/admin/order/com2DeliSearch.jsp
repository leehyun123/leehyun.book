...
<%
	...
	for(Order order : orderss){
		if(order.getDeliveryStatus().equals("구매확정"))
			orders.add(order);
	}
...
<body>
	...
	<div class="search_bar">
		<label class="search_label">주문관리 - 구매확정</label>
	</div>
	<div class="container">
		<div class="search_bar" style="background-color: white;">
			<form class="search_form" action="com2DeliSearch.jsp">
...
%>
					<tr><td colspan='5' style="height: 200px; padding-top: 80px; font-size: 35px;">주문 내역이 없습니다.</td></tr>
<%
				}
%>
				</tbody>
		...
		<button class="rf_btn" style="float: right; margin-right: 7px;" onclick="location.href='com2DeliOut.jsp'">뒤로가기</button>
	</div>
	<div class=footer>
		<hr>
		<p class='footertext'>
